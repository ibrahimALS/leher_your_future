...
require_once "config.php";
 ...
 $sql = "SELECT * FROM quiz ";
  $result = mysqli_query($conn, $sql);
                ...
                echo "<td><a href='deletequiz.php?id=". $row['quizid'] ."' title='Delete Record' data-toggle='tooltip'>Delete</a>&nbsp&nbsp&nbsp<a href='editquiz.php?id=". $row['quizid'] ."' title='Edit Record' data-toggle='tooltip'>Edit</a></td>";
