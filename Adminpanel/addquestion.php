...
if(!empty( $qname)&&!empty( $opta)&&!empty($optb)&&!empty( $optc)&&!empty( $optd)&&!empty( $ans))
{
    // Check input errors before inserting in database
        ...
        $sql = "INSERT INTO questions (title,optiona,optionb,optionc,optiond,answer,company_name) VALUES ( '$qname','$opta','$optb' ,'$optc','$optd','$ans','$cat')";
...
<div class="sidebar">
  ...
  <a href="#contact" class="active" >Add Question</a>
