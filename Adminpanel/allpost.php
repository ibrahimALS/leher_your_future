...
<div class="sidebar">
  ...
  <a href=""  class="active">Posts List</a>
                                    ...
                                    echo "<tr>";
                                     echo "<td>".$row['id']."</td> ";
                                        ...
                                        echo "<td>".$row['description']."</td> ";
                                         ...
                                         echo "<td><a href='delete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'>Delete</a>&nbsp&nbsp&nbsp</td>";
