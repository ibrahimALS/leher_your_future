...
<div class="sidebar">
  ...
  <a href=""  class="active">Category List</a>
...
<div class="content">
  <center><h2>List of Categories</h2></center>
...
<table>
  <tr style="background:#4CAF50;color:white;height:50px">
    <th>Category Name</th>
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    echo "<tr>";
                                        echo "<td>".$row['catname']."</td> ";
                                         echo "<td>".$row['catcreated']."</td> ";
                                          echo "<td><a href='deletecat.php?id=". $row['catid'] ."' title='Delete Record' data-toggle='tooltip'>Delete</a></td>";
