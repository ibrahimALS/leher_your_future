...
if(!empty( $qname)&&!empty( $opta)&&!empty($optb)&&!empty( $optc)&&!empty( $optd)&&!empty( $ans))
{
    // Check input errors before inserting in database
        ...
        $sql = "Update  questions set title='$qname',optiona='$opta',optionb='$optb',optionc='$optc',optiond='$optd',answer='$ans' where id='$qid'";
...
<div class="sidebar">
  ...
  <a  href="addpost.php">Add Post</a>
   <a  href="addqs.php">Add Question</a>
     ...
     <a class="active" href="questionlist.php">Questions List</a>
