...
if(!empty($tnumber)&&!empty( $timee)&&!empty($url))
{
    // Check input errors before inserting in database

       
        $sql = "INSERT INTO content (category,noq,timee,url) VALUES ( '$cat','$tnumber','$timee' ,'$url')";
...
<div class="content">
  <center><h2>Add Content</h2></center>
...
<div class="container">
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    ...
    <input type="text" id="qname" name="tnumber" placeholder="Enter Number Of Question">



<h7>Select Time</h7>
<input type="time" id="fname" name="timee"  style="display: block;width:390px;height:40px">
<br>
<h7>Category Description</h7>
<textarea name='url' placeholder="Text/Links.."></textarea>
