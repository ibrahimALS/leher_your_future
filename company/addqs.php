...
if(!empty( $qname)&&!empty( $opta)&&!empty($optb)&&!empty( $optc)&&!empty( $optd)&&!empty( $ans))
{
    // Check input errors before inserting in database
        ...
        $sql = "INSERT INTO questions (title,optiona,optionb,optionc,optiond,answer,company_name) VALUES ( '$qname','$opta','$optb' ,'$optc','$optd','$ans','$companyname')";
...
<div class="sidebar">
  ...
  <a  href="addpost.php">Add Post</a>
   <a class="active" href="addqs.php">Add Question</a>
...
<div class="container">
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    ...
    <input type="text" id="qname" name="qname" placeholder="Your Question..">

   <label for="fname">Question Options</label>


    <input type="text" id="opta" name="opta" placeholder="Option A">


    <input type="text" id="optb" name="optb" placeholder="Option B">

    <input type="text" id="optc" name="optc" placeholder="Option C">
   
    <input type="text" id="optd" name="optd" placeholder="Option D">
  <br>
   <input type="text" id="ans" name="ans" placeholder="Correct Option">
